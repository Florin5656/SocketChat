...
ArrayList<PrintWriter> clientOutputStreams;
   ...
   public class ClientHandler implements Runnable	
   {
    ...
    public void b_startActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_startActionPerformed
    ...
    public void userAdd (Collection<? extends String> data) 
    {
        String message, add = ": :Connect", done = "Server: :Done";
		Collection<? extends String> name = data;
        ta_chat.append("Before " + name + " added. \n");
        users.addAll(name);
        ta_chat.append("After " + name + " added. \n");
        String[] tempList = new String[(users.size())];
